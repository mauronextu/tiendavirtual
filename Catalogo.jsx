...
class Catalogo extends React.Component {
    constructor() {
      ...
      this.state = {
         mensaje :'mensaje desde catalogo',
         productos : [],
         productosConsulta: [],
         patronBusqueda: '',
         productosPedidos: []
    ...
    getProductos(){
        request
            .get('https://tiendavirtual-ddb09.firebaseio.com/1/productos.json')
            .set('Content-Type', 'application/json')
            .end((err, res) => {
                console.log(res.body);
                let productosRecuperados = res.body;
                request
                    .get('https://tiendavirtual-ddb09.firebaseio.com/2/pedidos.json')
                    .set('Content-Type', 'application/json')
